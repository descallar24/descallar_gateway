...
$router->put('/users1/{id}', 'User1Controller@update'); // update 
$router->patch('/users1/{id}', 'User1Controller@update'); // update 
...
$router->put('/users2/{id}', 'User2Controller@update'); // update 
$router->patch('/users2/{id}', 'User2Controller@update'); // update 
